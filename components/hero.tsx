...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
        ...
        <div className="max-w-3xl mx-auto">
          <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium mb-6 leading-tight transition-all duration-700 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
            Modern analytics
            <br />
            <span className="text-gray-200">for the modern world</span>
          </h1>
          <p className={`text-gray-300 text-base sm:text-lg md:text-xl max-w-xl mx-auto mb-8 transition-all duration-700 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
            varius enim in eros elementum tristique.
          </p>
          
          {/* CTA Buttons with hover effects */}
          <div className={`flex flex-col sm:flex-row justify-center gap-4 transition-all duration-700 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
        ...
        <div className={`mt-12 transition-all duration-1000 delay-900 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
          <div className="relative group">
            <div className="relative p-1 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg opacity-75 group-hover:opacity-100 transition duration-300">
              <div className="bg-black rounded-lg">
                <Image
                  ...
                  width={960}
                  height={472}
                  className="w-full max-w-4xl mx-auto object-contain rounded-lg shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-[1.01]"
                  priority
                />
              </div>
            </div>
        ...
        <div className={`mt-16 max-w-5xl mx-auto transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
